...
export default function ResumePage() {
  ...
  return (
    ...
    >
      ...
      {/* The document sheet */}
      <main
        className="mx-auto max-w-[820px] px-10 py-10 font-sans text-[13.5px] leading-relaxed shadow-[0_10px_40px_rgba(11,61,145,0.12)] ring-1 print:max-w-none print:px-[10mm] print:pb-[8mm] print:pt-0 print:text-[13.5px] print:leading-relaxed print:shadow-none print:ring-0"
      ...
      >
        ...
        <header className="break-inside-avoid text-center">
          ...
          <p
            className="mt-1 text-[15px] font-semibold print:text-[13.5px]"
            style={{ color: INK }}
          >
            {header.title}
          </p>
          ...
          {contactParts.length > 0 ? (
            <p className="mt-2.5 flex flex-wrap items-center justify-center gap-x-2 text-[12.5px] print:text-[13.5px]">
                ...
                {exp.roles.map((role, ri) => {
                  ...
                  >
                    <div className="flex items-baseline justify-between gap-4 break-after-avoid">
                      <h3
                        className="text-[14px] font-bold leading-snug print:text-[13.5px]"
                        style={{ color: NAVY }}
                      >
                        {titles.map((t, ti) => (
                      ...
                      <span
                        className="shrink-0 text-[12px] font-semibold print:text-[13.5px]"
                        style={{ color: '#55503f' }}
                      >
        ...
        <Section title="Technical Expertise">
          <div className="space-y-1.5">
            {skills.map((group) => (
              <p
                key={group.category}
                className="text-[12.5px] leading-relaxed print:text-[13.5px]"
              >
                <span className="font-bold" style={{ color: NAVY }}>
                  {group.category}:{' '}
                </span>
          ...
          <ul className="space-y-1">
            {education.map((e) => (
              <li
                ...
                className="text-[14px] print:text-[13.5px]"
              >
                <span className="font-semibold" style={{ color: INK }}>
                  {e.degree}
                </span>
        ...
        {header.languages.length > 0 ? (
          <Section title="Languages">
            <p className="flex flex-wrap items-center gap-x-2 text-[14px] print:text-[13.5px]">
